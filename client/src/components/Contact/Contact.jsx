...
function Contact() {
	...
	return (
		<div className='bg-purple-300 md:mt-[-120px] sm:mt-[-140px] sm:h-[700px] md:h-[600px]'>
			<div className='md:mb-4 md:pt-32 sm:pt-40'>
				...
				<h5 className='text-xl sm:pb-4 font-serif text-center'>
					We value your feedback. <br /> Contact us for comments, suggestions,
			...
			<form
				...
				<div className='text-center'>
					<button
						type='submit'
						className='relative font-serif inline-block rounded w-48 h-12 border-2 border-blue-900 bg-yellow-500 hover:bg-yellow-400 hover:text-blue-900 transform translate-[-0%] font-semibold'>

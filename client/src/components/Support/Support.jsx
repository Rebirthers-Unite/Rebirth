...
export const Support = () => {
  return (
    <div id='support-page'>
        ...
        <h1 id='title' className='text-7xl font-serif'>Donate</h1>
        <h1 className='text-3xl font-serif' style={{textAlign: 'center', marginTop: '120px'}} id='support-title'>Your donation will support...</h1>
        <SupportCards/>
        <h1 className='text-5xl font-serif' style={{textAlign: 'center', marginTop: '80px'}} id='donate-title'>You can donate through</h1>

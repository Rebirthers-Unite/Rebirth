	...
	return (
		<div className='w-full sm:pt-32 sm:mt-56 sm:pb-2 md:mt-2 md:pb-2 px-4 bg-[#9a9a9a]'>
			...
			<div
				...
				<div className='md:w-full sm:w-4/5 sm:ml-20 md:ml-2 shadow-xl flex bg-white text-black flex-col pt-0 my-4 ml-2 rounded-lg duration-300'>
						<img className='h-30 w-30 rounded' src={survivor1} alt='Survivor 1' />
						<div className='bg-white p-3 rounded'>
							<p className='font-light text-l italic text-gray-800'>
								"Thanks to Rebirth of a queen i can now put food on the table
								for my family"
							</p>
					...
					<div className='md:w-full sm:w-4/5 sm:ml-20 md:ml-2 shadow-xl flex bg-white text-black flex-col pt-0 md:mt-4 my-4 ml-2 rounded-lg duration-300'>
						<img className='h-30 w-30 rounded' src={survivor2} alt='Survivor 2' />
						<div className='bg-white p-3 rounded'>
							<p className='font-light text-l italic text-gray-800'>
								"I was a victim of Gender Based Violence and Rebirth of a Queen
								took me in, clothed me and educated me."
							</p>
							<p className='mt-1 font-semibold text-sm text-gray-900 p-4'>
								Beatrice Atieno
							</p>
				...
				<div className='md:w-full sm:w-4/5 sm:ml-20 md:ml-2 shadow-xl flex bg-white text-black flex-col pt-0 md:mt-4 my-4 ml-2 rounded-lg duration-300'>
						...
						<div className='bg-white p-3 rounded-lg'>
							<p className='font-light text-l italic text-gray-800'>
								"Thanks to Rebirth of a Queen I can now work towards my dream of
								becoming a lawyer."
							</p>

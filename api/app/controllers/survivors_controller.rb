class SurvivorsController < ApplicationController
  ...
  def survivor_params
    ...
    params.permit(:name, :date_of_birth, :organization, :organization_contact, :organization_email, :guardian_name, :contact_of_guardian, :level_of_education, :school, :social_asset_building, :date_of_entry, :date_of_exit)
  end
end
